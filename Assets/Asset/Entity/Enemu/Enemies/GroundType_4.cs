...
public class GroundType_4 : Enemu
{
    ...
    {
        Entity result = LevelManager.Instance.EnemuManager.SpawnEnemu<GroundType_4>(new Vector3(spawner.transform.position.x, spawner.transform.position.y, 0), spawner);
