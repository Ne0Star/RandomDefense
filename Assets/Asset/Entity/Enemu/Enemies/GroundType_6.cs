...
public class GroundType_6 : Enemu
{
    ...
    {
        Entity result = LevelManager.Instance.EnemuManager.SpawnEnemu<GroundType_6>(new Vector3(spawner.transform.position.x, spawner.transform.position.y, 0), spawner);
