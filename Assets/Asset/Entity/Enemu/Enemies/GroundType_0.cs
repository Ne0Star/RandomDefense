...
public class GroundType_0 : Enemu
{
    ...
    {
        Entity result = LevelManager.Instance.EnemuManager.SpawnEnemu<GroundType_0>(new Vector3(spawner.transform.position.x, spawner.transform.position.y, 0), spawner);
