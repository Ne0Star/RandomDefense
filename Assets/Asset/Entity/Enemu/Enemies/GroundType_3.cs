...
public class GroundType_3 : Enemu
{
    ...
    {
        Entity result = LevelManager.Instance.EnemuManager.SpawnEnemu<GroundType_3>(new Vector3(spawner.transform.position.x, spawner.transform.position.y, 0), spawner);
