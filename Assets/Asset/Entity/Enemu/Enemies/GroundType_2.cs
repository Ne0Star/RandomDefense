...
public class GroundType_2 : Enemu
{
    ...
    {
        Entity result = LevelManager.Instance.EnemuManager.SpawnEnemu<GroundType_2>(new Vector3(spawner.transform.position.x, spawner.transform.position.y, 0), spawner);
